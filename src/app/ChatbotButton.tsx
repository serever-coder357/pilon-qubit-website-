...
export default function ChatbotButton() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      {open && (
        <div className="absolute bottom-24 right-0 w-96 h-96 bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 p-5 overflow-y-auto space-y-4 bg-gray-50">
            ...
            {input && (
              <div className="flex justify-end">
                <div className="max-w-xs px-5 py-3 rounded-2xl bg-blue-600 text-white opacity-70">{input}</div>
              </div>
            )}
          ...
          <div className="p-5 bg-white border-t">
            <div className="flex gap-3">
              ...
              <button
                onClick={handleSend}
                className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold rounded-full hover:from-cyan-400 hover:to-blue-500 transition-all"
              >
                Send
              </button>
            </div>
