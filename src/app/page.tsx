export default function Page() {
  return (
    <main className="bg-[#04061a] text-white">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
            ...
            <div className="space-y-6 max-w-xl">
              ...
              <p className="text-base text-slate-200 sm:text-lg">
                We partner with visionary founders and forward-thinking enterprises to transform
                bold ideas into market-ready products. Combining venture perspective with hands-on
                engineering, we deliver AI and quantum solutions that ship fast, scale reliably,
            ...
            <div className="w-full lg:max-w-xl">
              <div className="relative w-full overflow-hidden rounded-3xl shadow-lg aspect-[16/9]">
                ...
                >
                  <source
                    src="https://pilonqubitventures.com/pqv-new.mp4"
                    type="video/mp4"
                  />
                </video>
              </div>
      ...
      {/* TODO: Re-add other sections (services, case studies, contact form) below this hero if needed */}
    </main>
  );
}
